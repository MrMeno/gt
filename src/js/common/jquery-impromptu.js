(function(root, factory) {
	...
	/**
	* Imp - Impromptu object - 不给imp设置参数，将不会打开弹出框，只会返回一个object
	* @param message String/Object - String of html or Object of states
	* @param options 对象 - Options 来设置 prompt
	* @return Imp -  Impromptu object的该实例
	*/
	...
	*/
	Imp.defaults = {
		...
		classes: {
			...
			defaultButton: '',
			picture:'',
			/*widget:{var w_type,var w_text,var w_class,var w_id}*/
		},
		picture:'',
		title: '',
		/*widget:'',*/
		...
		buttonTimeout: 1000,
		loaded: function(e){},
		submit: function(e,v,m,f){return v},
	...
	Imp.prototype = {
		...
		*/
		addState: function(statename, stateobj, afterState) {
			...
			if (stateobj.picture&&stateobj.picture!=='') {
				picture="<img class='pic' src='"+stateobj.picture+"'>";
			};
          /*  if (stateobj.widget&&stateobj.widget!==''&&stateobj.title==null)
             {
            	for (var i = 0; i <= widget.w_type.length; i++) {
            		widget="<"+widget.w_type[i]+"class="+widget.w_class[i]+"id="+widget.w_id[i]+"value="+widget.w_text+">";
            	}				
			};*/
			...
			state += '<div class="'+ opts.prefix + 'state" data-jqi-name="'+ statename +'">'+
						arrow + title +/*widget*/
						'<div class="'+ opts.prefix +'message '+ opts.classes.message +'">'+picture+ showHtml +'</div>'+
